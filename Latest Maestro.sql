...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2024 at 09:50 AM
...
INSERT INTO `customers` (`CustomerID`, `CustomerName`, `City`, `PostalCode`, `Address`, `ContactName`, `Country`, `DateOfBirth`) VALUES
(1, 'Moshfeque Jahan', 'Canbera', '4001', 'Swinburne', 'Rupak E', 'Australia', NULL),
(2, 'Michael', 'New York', '2001', 'California', 'Scott', 'USA', NULL),
(3, 'Dwight', 'New York', '2003', 'Stanford', 'Schrute', 'USA', NULL),
(4, 'Havagenza', 'Pabliaso', '0', 'Sao Paolo', 'Gonzalez', 'Mexico', NULL),
(5, 'Leeyam', 'Dhaka', '1216', 'Mirpur-10', 'Jhankar Mahbub', 'Bangladesh', NULL),
(6, 'Omar Ahmed', 'Dimai', '5001', 'Usmannii', 'Ghani', 'Oman', NULL),
(8, 'Hayama', 'Japan', '3230', 'Otakutsai-Yokohama', 'Yukihira', 'Japan', NULL);
